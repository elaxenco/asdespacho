...
<body id="bodyHome" onload="controlesZonasSuc()">
            ...
            <div class="container-fluid ">
                ...
                <div class="card mt-2">
                    <div class="card-header bg-themes" id="headingOne">
                        <a  onclick="agregarZona()"  class="btn btn-success float-right text-light" data-toggle="modal" data-target="#modalNuevaZona">
                    ...
                    <div class="card-body">
                        <div class="table-responsive-md">
                            <table class="table table-sm table-hover table-bordered table-striped small">
                                <thead>
                                    <tr>
                                        <th scope="col" class="text-center">ID Zona</th>
    ...
    <!-- /#wrapper -->  
    <?php   include('../modals/modalZonasSuc.php'); ?> 
    ...
    <script type="text/javascript" src="../js/zonassuc.js"></script> 
