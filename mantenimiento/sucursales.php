...
<body id="bodyHome" onload="controlesSuc()">
        ...
        <div id="page-content-wrapper">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
                <button class="btn btn-outline-primary" id="menu-toggle" onclick="ocultarMenu()"> <i id="icono"
                        ...
                        <h4 class="ml-2 mt-2">Sucursales</h4>
            ...
            <div class="container-fluid ">
                ...
                <div class="card mt-2">
                    <div class="card-header bg-themes" id="headingOne">
                        <a  onclick="agregarSucursal()" class="btn btn-success float-right text-light" data-toggle="modal" data-target="#modalSucursalesNueva">
